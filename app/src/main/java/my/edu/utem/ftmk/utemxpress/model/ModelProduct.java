...
public class ModelProduct {
    ...
    discountPrice, discountNote, discountAvailable,
    timestamp,uid;
    ...
    public static Comparator<ModelProduct> ModelProductNameAZComparator = new Comparator<ModelProduct>() {
        @Override
        public int compare(ModelProduct p1, ModelProduct p2) {
            return p1.getProductTitle().compareTo(p2.getProductTitle());
        }
    };
    public static Comparator<ModelProduct> ModelProductNameZAComparator = new Comparator<ModelProduct>() {
        @Override
        public int compare(ModelProduct p1, ModelProduct p2) {
